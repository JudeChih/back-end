            ...
            <table class="table-template-edit">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/project/list" class="btn btn-cancel btn_back">返回</a>
                    </td>
                </tr>
            </table>
        </div>
...
export default {
    ...
    methods: {
        ...
        createProject:function(){
            ...
            // 回傳修改
			axios.post(this.$server_api +'/project-create',self.project.project) //新增 - 版型資料
                .then(function (response) {
        ...
        modifySignColor:function(){
			...
			if(self.project.alreadyChange.earth){
			...
			if(self.project.alreadyChange.wind){
			...
			if(self.project.alreadyChange.water){
